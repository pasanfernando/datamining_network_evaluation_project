...
customfunctions = ['uberon_0000033','uberon_0001944','uberon_0009124']
...
out1.write('function\tnumber_of_genes\tROC_auc\tPR_auc\n')

print funcstat

for i in funcstat:
    out1.write('%s\t%s\t%s\t%s\n'%(i,funcstat[i]['num_functions'],funcstat[i]['rauc'],funcstat[i]['pauc']))